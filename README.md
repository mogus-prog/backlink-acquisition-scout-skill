# Backlink Acquisition Scout (OpenClaw Skill)

**Build better OpenClaw bots, faster.**

Identifies and prioritizes backlink prospects and structures outreach/follow-up plans.
...
- Run focused automation workflows around **Backlink Acquisition Scout**
...
```bash
# Clone
git clone https://github.com/mogus-prog/backlink-acquisition-scout-skill.git
cd backlink-acquisition-scout-skill
